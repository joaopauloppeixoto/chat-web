...
import { EllipsisVertical, LogOut, Mail, MessageSquare, MonitorCog, Moon, PlusCircle, Settings, Sun, SunMoon, User, UserPlus } from "lucide-react";
import {
  Avatar,
  AvatarFallback,
  AvatarImage
...
import { DropdownMenu, DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuGroup, DropdownMenuItem, DropdownMenuLabel, DropdownMenuPortal, DropdownMenuSeparator, DropdownMenuShortcut, DropdownMenuSub, DropdownMenuSubContent, DropdownMenuSubTrigger } from "./ui/dropdown-menu";
...
export default function ProfileInfo({ }: ProfileInfoProps) {
  ...
  return (
    <div className="p-2 h-20 flex flex-row">
      <div className="my-auto flex flex-row gap-3 flex-1">
